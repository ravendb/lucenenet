...
namespace Lucene.Net.Util
{
        ...
        where TComparer : IEqualityComparer<TKey>
    {
        ...
        protected FastDictionaryBase(int initialBucketCount, FastDictionaryBase<TKey, TValue, TComparer> src, TComparer comparer)
        {
            ...
            this._initialCapacity = BitUtil.NextHighestPowerOfTwo(initialBucketCount);
        ...
        protected FastDictionaryBase(int initialBucketCount, TComparer comparer)
        {
            ...
            newCapacity = BitUtil.NextHighestPowerOfTwo(newCapacity);
        ...
        {
            // Calculate the next power of 2.
            newCapacity = Math.Max(BitUtil.NextHighestPowerOfTwo(newCapacity), _initialCapacity);
