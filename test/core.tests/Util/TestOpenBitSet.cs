			...
			for (int i = 0; i < iter; i++)
			{
				...
				if (a0 != null)
				{
                    ...
                    if (a.Length < a0.Length)
                    {
                        ...
                        a_andn = (System.Collections.BitArray)tmp.Clone(); for (int j = 0; j < a_andn.Length; j++) if (a0.Get(j)) a_andn.Set(j, false);
                    }
                    else if (a.Length > a0.Length)
                    {
                        ...
                        a_andn = (System.Collections.BitArray)a.Clone(); for (int j = 0; j < a_andn.Length; j++) if (a0.Get(j)) a_andn.Set(j, false);
                    }
                    else
                    {
