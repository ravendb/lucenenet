...
namespace Lucene.Net.Documents
{
	...
	public class TestDateTools:LocalizedTestCase
	{
		...
		public virtual void  TestStringtoTime()
		{
            ...
            System.DateTime cal = new System.Globalization.GregorianCalendar().ToDateTime(1970, 1, 1, 0, 0, 0, 0);  // hour, minute, second
            Assert.AreEqual(cal.Ticks, time);

			cal = new System.Globalization.GregorianCalendar().ToDateTime(1980, 2, 2, 11, 5, 0, 0); // hour, minute, second
        ...
        {
            System.DateTime cal = new System.Globalization.GregorianCalendar().ToDateTime(2004, 2, 3, 22, 8, 56, 333);
			...
			// date before 1970:
            cal = new System.Globalization.GregorianCalendar().ToDateTime(1961, 3, 5, 23, 9, 51, 444);
			...
			// timeToString:
            cal = new System.Globalization.GregorianCalendar().ToDateTime(1970, 1, 1, 0, 0, 0, 0);
            ...
            cal = new System.Globalization.GregorianCalendar().ToDateTime(1970, 1, 1, 1, 2, 3, 0);
			dateString = DateTools.TimeToString(cal.Ticks / TimeSpan.TicksPerMillisecond, DateTools.Resolution.MILLISECOND);
        ...
        {
            System.DateTime date = new System.Globalization.GregorianCalendar().ToDateTime(2004, 2, 3, 22, 8, 56, 333);
