...
namespace Lucene.Net.Support
{
    ...
    public class TestOldPatches
    {
        ...
        public void Test_Store_RAMDirectory()
        {
            ...
            //Index 1 Doc
            Lucene.Net.Index.IndexWriter wr = new Lucene.Net.Index.IndexWriter(ramDIR, new Lucene.Net.Analysis.WhitespaceAnalyzer(), true, IndexWriter.MaxFieldLength.UNLIMITED, null);
            ...
            //Add 1 more doc
            wr = new Lucene.Net.Index.IndexWriter(ramDIR2, new Lucene.Net.Analysis.WhitespaceAnalyzer(), false, IndexWriter.MaxFieldLength.UNLIMITED, null);
            ...
            //Search
            Lucene.Net.Search.IndexSearcher s = new Lucene.Net.Search.IndexSearcher(ramDIR2, null);
            ...
            Lucene.Net.Search.TopDocs topDocs = s.Search(q, 100, null);
            s.Close();
        ...
        public void Test_Search_FieldDoc()
        {
            ...
            Lucene.Net.Search.IndexSearcher indexSearcher = new Lucene.Net.Search.IndexSearcher(LUCENENET_100_Dir, null);
        ...
        void LUCENENET_100_ClientSearch()
        {
            try
            {
                Lucene.Net.Search.Searchable s = (Lucene.Net.Search.Searchable)Activator.CreateInstance(typeof(Lucene.Net.Search.Searchable), @"tcp://localhost:" + ANYPORT + "/Searcher");
                ...
                Lucene.Net.Search.TopDocs h = searcher.Search(q, null, 100, sort, null);
