...
namespace Contrib.Regex.Test
{
    ...
    public class TestSpanRegexQuery : TestCase
    {
        ...
        public void TestSpanRegex()
        {
            ...
            IndexWriter writer = new IndexWriter(directory, new SimpleAnalyzer(), true, IndexWriter.MaxFieldLength.UNLIMITED, null);
            ...
            // true);
            int numHits = searcher.Search(sfq, null, 1000, null).TotalHits;
        ...
        public void TestSpanRegexBug()
        {
            ...
            arrSearcher[0] = new IndexSearcher(indexStoreA, true, null);
            arrSearcher[1] = new IndexSearcher(indexStoreB, true, null);
            MultiSearcher searcher = new MultiSearcher(arrSearcher);
            int numHits = searcher.Search(query, null, 1000, null).TotalHits;
            arrSearcher[0].Close();
            arrSearcher[1].Close();
        ...
        private void CreateRamDirectories()
        {
            ...
            IndexWriter writerA = new IndexWriter(indexStoreA, new StandardAnalyzer(Version.LUCENE_CURRENT),
                true, IndexWriter.MaxFieldLength.LIMITED, null);
            ...
            IndexWriter writerB = new IndexWriter(indexStoreB, new StandardAnalyzer(Version.LUCENE_CURRENT),
                true, IndexWriter.MaxFieldLength.LIMITED, null);
            writerB.AddDocument(lDoc2, null);
